      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link as={Link} href="/" className="active">Fresh Vegetables</Nav.Link>
            {session && (
              <>
                <Nav.Link as={Link} href="/orders">Orders & Deliveries</Nav.Link>
          ...
          <Nav className="align-items-center">
            ...
            >
              <div className="position-relative">
                <i className="ti-shopping-cart text-success" style={{ fontSize: '1.5rem' }}></i>
                {items.length > 0 && (
                  <div 
